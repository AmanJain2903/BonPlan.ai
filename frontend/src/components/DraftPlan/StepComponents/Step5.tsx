...
export function Step5BudgetPacing({ tripData, updateTripData, onNext, registerCommit }: Step5Props) {
  const stepMeta = useMemo(
    () => PLAN_STEPS.find((s) => s.id === 'budget-pacing'),
    [],
  );
  ...
  // Commit-on-back should mirror YES, but not navigate.
  ...
  }, [budget, canConfirm, pace, registerCommit, updateTripData]);

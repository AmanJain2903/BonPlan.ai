...
export default function Register() {
  ...
  const inputClass =
    'w-full rounded-xl border border-white/10 bg-white/[0.03] px-4 py-2.5 text-base sm:text-sm text-white placeholder-white/20 outline-none focus:border-cyan/40 focus:ring-1 focus:ring-cyan/20 transition-all duration-200';
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className={`w-full rounded-xl border bg-white/[0.03] px-4 py-2.5 pr-10 text-base sm:text-sm text-white placeholder-white/20 outline-none transition-all duration-200 ${passwordMismatch

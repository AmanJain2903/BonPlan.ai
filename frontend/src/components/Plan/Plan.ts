...
export const COMMON_PLAN_STEPS: PlanStepMeta[] = [
  {
    step: 1,
    id: 'planning-style',
...
/** Steps specific to the Solo • Single Hub flow */
export const SOLO_SINGLE_HUB_STEPS: PlanStepMeta[] = [
  {
    step: 3,
    id: 'source-destination',
    title: "Let's anchor our trip, {name}.",
    description: "Solo • Single Hub — tell us where we're starting and where we're headed",
    options: [],
    componentKey: 'solo-single-places',
  },
  {
    step: 4,
    id: 'start-end-dates',
    title: "Let's set the timeline, {name}.",
    description: "Solo • Single Hub — tell us when are we traveling",
    options: [],
    componentKey: 'solo-single-dates',
  },
  {
    step: 5,
    id: 'budget-pacing',
    title: "Let's talk pace and budget, {name}.",
    description: "Solo • Single Hub — tell us your budget and if you want a relaxed getaway or an action-packed adventure",
    options: [
      {
        id: 'pace',
        title: 'Trip Pace',
    ...
    componentKey: 'solo-single-budget-pacing',
  },
  {
    step: 6,
    id: 'conversational-context',
    title: "Let's talk about our trip, {name}.",
    description: "Solo • Single Hub — tell us anything else you want to add to your trip",
    componentKey: 'solo-single-conversation',
  },
];
...
## Returns
- **Success**: `{"nbRooms", "nbAdults", "nbChildren", "lengthOfStayInDays", "checkinDate", "checkoutDate", "hotels": [...]}`. Each hotel includes `propertyInfo`, `checkInOutInfo`, `priceInfo`, and `isSoldOut`.

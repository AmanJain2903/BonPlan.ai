...
# async def generate_trip_itinerary(trip_payload: dict, mode: Literal["autonomous", "collaborative", "editing"] = "autonomous", current_trip_itinerary: Optional[list[AddItineraryEvent]] = None, owner_id: Optional[str] = None, trip_id: Optional[str] = None, cancellation_callback: Optional[Callable[[], Awaitable[bool]]] = None) -> AsyncGenerator[Dict[str, Any], None]:
...
AUTONOMOUS_PROMPT_PATH = os.path.join(
